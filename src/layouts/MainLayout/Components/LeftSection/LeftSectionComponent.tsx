...
export const LeftSectionComponent = () => {
  ...
  return (
    <div
      ...
      } border-r min-h-fit xl:min-h-auto xl:border-none hidden overflow-y-auto col-span-4 xl:col-span-3 h-[90vh] xl:h-[100vh] sticky top-[10vh] xl:top-0 pl-10 lg:pl-20 2xl:pl-30 text-start md:flex flex-col justify-between py-10`}
    >
      <div>
        <LogoHeader />
