  ...
  return (
    ...
    >
      <div
        ...
        } text-start overflow-x-hidden md:rounded-2xl p-2 md:p-4 w-full md:w-[70vw] lg:w-[60vw] xl:w-[50vw] 2xl:w-[50vw] flex flex-col gap-4 overflow-y-auto h-screen md:h-fit`}
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
